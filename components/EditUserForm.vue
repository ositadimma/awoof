  ...
  >
    <div class="new-user-form animate__fadeIn">
      ...
      <div class="form">
        ...
        <input v-model="userDetail.firstName" type="text" placeholder="Please Enter">
        <label>Last Name</label>
        <input v-model="userDetail.lastName" type="text" placeholder="Please Enter">
        <label>Username</label>
        <input v-model="userDetail.username" type="text" placeholder="Please Enter">
        ...
        >
          <div class="default-option" @click="selectGender(userDetail.gender)">
            {{ userDetail.gender }}
          </div>
        ...
        <input v-model="userDetail.email" type="email" placeholder="Please Enter">
        <label>Date Of Birth</label>
        <input v-model="userDetail.dateOfBirth" type="date" placeholder="Please Enter">
        <label class="locationlabel">Location</label>
        <input v-model="userDetail.location" type="text" placeholder="Please Enter">
        <label>Phone Number</label>
        <input v-model="userDetail.phonenumber" type="text" placeholder="Please Enter">
        <!-- <label class="locationlabel">Referral Code</label>
        <input v-model="userDetail.referralCode" type="text" placeholder="Please Enter"> -->
        <button v-show="!validate && !loading" class="btn-cmpt" @click="editUser">
          Update User
        </button>
        <button
...
export default {
  ...
  data () {
    return {
      ...
      dateOfBirth: this.userDetail.dateOfBirth.toString(),
      // image: this.image,
      phonenumber: this.userDetail.phoneNumber,
      location: this.userDetail.location,
      // referralCode: this.userDetail.referralCode,
      loading: false
    }
  },
  computed: {
  ...
  methods: {
    ...
    setDataToDefault () {
      ...
      this.dateOfBirth = this.userDetail.dateOfBirth
    ...
    async editUser () {
      ...
      try {
        const response = await this.$axios.$post(
          `/users/update/${this.userDetail._id}`, this.bodyData()
        )
        if (response) {
          this.$toast.global.custom_success('User Updated')
          this.$nuxt.refresh()
